...
const happySad = (n) => { 
    if (n >= 1) {
        return new Promise((resolve) => resolve('happy'))
    } else {
        return new Promise((resolve, reject) => reject('sad'));
    }
};
...
const amIYourFather = (x) => {
    if (x == 'Luke') {
        return new Promise((resolve) => resolve('Yes. Luke, I am your father.'))
    } else {
        return new Promise((resolve, reject) => reject('Not your dad.'));
    }
 };
